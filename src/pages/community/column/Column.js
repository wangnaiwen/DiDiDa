...
export default class HomePage3 extends Component {
    ...
    _renderHeader(){
        ...
        return (
            <View style={scrollStyles.header}>
                <Animated.View style={[scrollStyles.lbsWeather, {opacity: lbsOpaticy}]}>
                    <Text>头</Text>
                </Animated.View>
                <Animated.View style={{marginTop: px2dp(15), transform: [{translateY: searchY}]}}>
                    <Text>中</Text>
                </Animated.View>
                <Animated.View style={[scrollStyles.keywords, {opacity: keyOpaticy}]}>
                    <Text>底</Text>
                </Animated.View>
            </View>
        )
    ...
    _renderFixHeader(){
        ...
        return (
            <Animated.View style={[scrollStyles.header, {
                position: "absolute",
                left: 0,
                right: 0,
                top: 0,
